                        ...
                        <table className='json-preview'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>This contains the chapter IDs which are from al-shamela in the following format: {"<unique chapter_id>:<unique_chapter_parent_id"}, which is used to denote chapters and subchapters. It denotes which chapters are subchapters of other chapters, and if the parent_id is "0" that means it is a book-level chapter. Note that each chapter has a unique chapter_id and in no way denotes the sequence of chapters
                                    </td>
                                </tr>
                            </tbody>
                        </table>
